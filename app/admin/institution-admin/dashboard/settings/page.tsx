    ...
    <div className="space-y-5 max-w-xl">
      ...
      <Section icon={LogOut} title="Session">
        <div className="space-y-2">
          <p className="text-sm text-slate-400">Sign out of your institution admin account on this device.</p>
          <button
            onClick={signOut}
            className="flex items-center gap-2 rounded-xl border border-red-500/30 bg-red-500/10 hover:bg-red-500/20 px-4 py-2.5 text-sm font-medium text-red-400 transition-colors"
          >
