...
import { Eye, EyeOff, Landmark, ArrowLeft, LogIn } from "lucide-react";
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/80 backdrop-blur-sm shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            <div className="flex flex-col items-center gap-2 mb-7">
              ...
              <h1 className="text-xl font-bold text-slate-100">Institution Sign In</h1>
              <p className="text-xs text-slate-500 text-center">
                Access your institution&apos;s administration portal
              </p>
            </div>
            ...
            <form className="space-y-4" onSubmit={onSubmit}>
              {/* Email */}
              <div>
                <label className={lbl} htmlFor="inst-email">Email Address</label>
                <input
                  id="inst-email"
                  type="email"
                  required
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className={lbl.replace("mb-1.5", "")} htmlFor="inst-password">Password</label>
                  <Link
                    href="/admin/institution-admin/forgot-password"
            ...
            <p className="mt-6 text-center text-xs text-slate-500">
              ...
              <Link href="/admin/institution-admin/register" className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors">
                Create account
              </Link>
            </p>
          </div>
